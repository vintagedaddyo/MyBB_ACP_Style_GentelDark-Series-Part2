# MyBB_ACP_Style_GentelDark-Series-Part2

GentelDark Series: Part 2 is several dark variants of the MyGentelella style which is a theme for the MyBB AdminCp. The theme is responsive and it is maded with bootstrap. The theme is based on the Gentelella admin control panel of Colorlib.
...
4.) Select "Gentelawny" & then press: "Save Personal Notes & Preferences"
...
2.) Upload contents of "Upload" into your forums folder.
3.) Go to the Admin Control Panel under Preferences > Global Preferences > Admin Control Panel Theme
4.) Select "Gentelim" & then press: "Save Personal Notes & Preferences"
5.) Now have fun with your new forum ACP Style!
